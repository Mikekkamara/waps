...
<body>
  <div class="vh-100  position-relative">
      <a class="btn  btn-primary m-3 end-0 position-absolute" style="z-index: 6" 
        href="{{ route('login') }}">
        Login
      </a>

      <div class="d-none  d-sm-flex flex-wrap w-100 h-fit-content position-absolute start-0 end-0 top-0 bottom-0 m-auto" style="flex-basis: 25%">
        <div class="card w-25 h-fit-content bg-transparent m-4  border-0 flex-grow-1" >
